...
interface IInAppBillingService {
    ...
    */
    ...
    Bundle getSubscriptionManagementIntent(int apiVersion, String packageName, String sku, String type, in Bundle extraParams);

    Bundle getPurchasesExtraParams(int apiVersion, String packageName, String type, String continuationToken, in Bundle extraParams);

    Bundle consumePurchaseExtraParams(int apiVersion, String packageName, String purchaseToken, in Bundle extraParams);

    Bundle getSkuDetailsExtraParams(int apiVersion, String packageName, String type, in Bundle skusBundle, in Bundle extraParams);

    Bundle acknowledgePurchaseExtraParams(int apiVersion, String packageName, String purchaseToken, in Bundle extraParam);
