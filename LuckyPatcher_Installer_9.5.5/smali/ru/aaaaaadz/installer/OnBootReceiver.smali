.class public Lru/aaaaaadz/installer/OnBootReceiver;
...
.method static constructor <clinit>()V
    ...
    .line 30
    sput-object v0, Lru/aaaaaadz/installer/OnBootReceiver;->bootlist:[Ljava/lang/String;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    .line 36
    sput-object p1, Lru/aaaaaadz/installer/OnBootReceiver;->contextB:Landroid/content/Context;
    ...
    new-instance v2, Lru/aaaaaadz/installer/OnBootReceiver$1;

    invoke-direct {v2, p0}, Lru/aaaaaadz/installer/OnBootReceiver$1;-><init>(Lru/aaaaaadz/installer/OnBootReceiver;)V
    ...
    new-instance v1, Lru/aaaaaadz/installer/OnBootReceiver$2;

    invoke-direct {v1, p0, p1}, Lru/aaaaaadz/installer/OnBootReceiver$2;-><init>(Lru/aaaaaadz/installer/OnBootReceiver;Landroid/content/Context;)V
    ...
    const-class v6, Lru/aaaaaadz/installer/PatchService;
    ...
    const-class v5, Lru/aaaaaadz/installer/PatchService;
    ...
    const-class v5, Lru/aaaaaadz/installer/OnAlarmReceiver;

    invoke-direct {v3, p1, v5}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    .line 138
    sget-object v5, Lru/aaaaaadz/installer/OnAlarmReceiver;->ACTION_WIDGET_RECEIVER:Ljava/lang/String;
    ...
    new-instance v3, Lru/aaaaaadz/installer/OnBootReceiver$3;

    invoke-direct {v3, p0, v0}, Lru/aaaaaadz/installer/OnBootReceiver$3;-><init>(Lru/aaaaaadz/installer/OnBootReceiver;Landroid/os/Handler;)V
    ...
    const-class v2, Lru/aaaaaadz/installer/MainActivity;
