.class Lru/aaaaaadz/installer/PatchService$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lru/aaaaaadz/installer/PatchService;->onStartCommand(Landroid/content/Intent;II)I
.end annotation
...
# instance fields
.field final synthetic this$0:Lru/aaaaaadz/installer/PatchService;


# direct methods
.method constructor <init>(Lru/aaaaaadz/installer/PatchService;)V
    .locals 0

    .line 78
    iput-object p1, p0, Lru/aaaaaadz/installer/PatchService$1;->this$0:Lru/aaaaaadz/installer/PatchService;
...
.method public run()V
    ...
    iget-object v9, p0, Lru/aaaaaadz/installer/PatchService$1;->this$0:Lru/aaaaaadz/installer/PatchService;

    invoke-virtual {v9}, Lru/aaaaaadz/installer/PatchService;->getApplicationContext()Landroid/content/Context;
    ...
    .line 90
    :goto_0
    iget-object v3, p0, Lru/aaaaaadz/installer/PatchService$1;->this$0:Lru/aaaaaadz/installer/PatchService;

    iget-object v3, v3, Lru/aaaaaadz/installer/PatchService;->handler:Landroid/os/Handler;

    new-instance v7, Lru/aaaaaadz/installer/PatchService$1$1;

    invoke-direct {v7, p0}, Lru/aaaaaadz/installer/PatchService$1$1;-><init>(Lru/aaaaaadz/installer/PatchService$1;)V
    ...
    iget-object v7, p0, Lru/aaaaaadz/installer/PatchService$1;->this$0:Lru/aaaaaadz/installer/PatchService;

    invoke-virtual {v7}, Lru/aaaaaadz/installer/PatchService;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual {v3}, Lru/aaaaaadz/installer/PatchService;->getApplicationInfo()Landroid/content/pm/ApplicationInfo;
    ...
    invoke-virtual {v3}, Lru/aaaaaadz/installer/PatchService;->getPackageManager()Landroid/content/pm/PackageManager;
    ...
    iget-object v8, p0, Lru/aaaaaadz/installer/PatchService$1;->this$0:Lru/aaaaaadz/installer/PatchService;

    invoke-virtual {v8}, Lru/aaaaaadz/installer/PatchService;->dexoptcopy()V
    ...
    .line 146
    sget v9, Lru/aaaaaadz/installer/PatchService;->notifyIndex:I
    ...
    sput v9, Lru/aaaaaadz/installer/PatchService;->notifyIndex:I
    :try_end_6
    ...
    invoke-virtual {v7, v8, v6}, Lru/aaaaaadz/installer/PatchService;->getDir(Ljava/lang/String;I)Ljava/io/File;
    ...
    iget-object v1, p0, Lru/aaaaaadz/installer/PatchService$1;->this$0:Lru/aaaaaadz/installer/PatchService;

    const v10, 0x7f110301

    invoke-virtual {v1, v10}, Lru/aaaaaadz/installer/PatchService;->getString(I)Ljava/lang/String;
    ...
    .line 204
    :cond_6
    sget v2, Lru/aaaaaadz/installer/PatchService;->notifyIndex:I
    ...
    iget-object v0, p0, Lru/aaaaaadz/installer/PatchService$1;->this$0:Lru/aaaaaadz/installer/PatchService;

    const v8, 0x7f110300

    invoke-virtual {v0, v8}, Lru/aaaaaadz/installer/PatchService;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {v7, v8}, Lru/aaaaaadz/installer/PatchService;->getString(I)Ljava/lang/String;
    ...
    .line 205
    sget v0, Lru/aaaaaadz/installer/PatchService;->notifyIndex:I

    add-int/2addr v0, v5

    sput v0, Lru/aaaaaadz/installer/PatchService;->notifyIndex:I
    :try_end_a
    ...
    iget-object v0, v0, Lru/aaaaaadz/installer/PatchService;->context:Landroid/content/Context;
    ...
    iget-object v2, p0, Lru/aaaaaadz/installer/PatchService$1;->this$0:Lru/aaaaaadz/installer/PatchService;

    iget-object v2, v2, Lru/aaaaaadz/installer/PatchService;->context:Landroid/content/Context;
    ...
    iget-object v0, v0, Lru/aaaaaadz/installer/PatchService;->handler:Landroid/os/Handler;

    new-instance v1, Lru/aaaaaadz/installer/PatchService$1$2;

    invoke-direct {v1, p0}, Lru/aaaaaadz/installer/PatchService$1$2;-><init>(Lru/aaaaaadz/installer/PatchService$1;)V
    ...
    new-instance v1, Lru/aaaaaadz/installer/PatchService$1$3;

    invoke-direct {v1, p0}, Lru/aaaaaadz/installer/PatchService$1$3;-><init>(Lru/aaaaaadz/installer/PatchService$1;)V
    ...
    invoke-virtual {v0}, Lru/aaaaaadz/installer/PatchService;->stopSelf()V
