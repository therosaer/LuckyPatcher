...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroidx/ˉ/ᴵ;->ʻ:Z
    ...
    :goto_1
    sput-boolean v0, Landroidx/ˉ/ᴵ;->ʼ:Z
    ...
    :goto_2
    sput-boolean v1, Landroidx/ˉ/ᴵ;->ʽ:Z

    return-void
.end method

.method static ʻ(Landroid/animation/Animator;Landroid/animation/Animator;)Landroid/animation/Animator;
    .locals 3
...
.method private static ʻ(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
    .locals 8

    .line 93
    sget-boolean v0, Landroidx/ˉ/ᴵ;->ʻ:Z
    ...
    .line 102
    :goto_1
    sget-boolean v3, Landroidx/ˉ/ᴵ;->ʼ:Z
    ...
    .line 120
    sget-boolean p2, Landroidx/ˉ/ᴵ;->ʽ:Z
    ...
    :cond_5
    :goto_3
    sget-boolean p1, Landroidx/ˉ/ᴵ;->ʼ:Z
...
.method static ʻ(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/View;)Landroid/view/View;
    ...
    .line 53
    invoke-static {p1, v0}, Landroidx/ˉ/ʻʻ;->ʻ(Landroid/view/View;Landroid/graphics/Matrix;)V

    .line 54
    invoke-static {p0, v0}, Landroidx/ˉ/ʻʻ;->ʼ(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    .line 64
    invoke-static {p1, v0, p2, p0}, Landroidx/ˉ/ᴵ;->ʻ(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;Landroid/view/ViewGroup;)Landroid/graphics/Bitmap;
