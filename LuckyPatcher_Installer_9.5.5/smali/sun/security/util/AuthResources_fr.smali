...
.method static constructor <clinit>()V
    ...
    const-string v3, "entr\u00e9e Null non valide {0}"
    ...
    const-string v3, "Valeur de NTSid non valide"
    ...
    const-string v3, "UnixNumericGroupPrincipal [groupe principal] : {0}"
    ...
    const-string v3, "UnixNumericGroupPrincipal [groupe suppl\u00e9mentaire] : {0}"
    ...
    const-string v3, "Impossible de d\u00e9velopper {0} correctement"
    ...
    const-string v3, "{0} (fichier ou r\u00e9pertoire introuvable)"
    ...
    const-string v3, "Impossible de trouver une configuration de connexion"
    ...
    const-string v3, "Erreur de configuration :\n\tIndicateur de contr\u00f4le non valide, {0}"
    ...
    const-string v3, "Nom d\'utilisateur : "
    ...
    const-string v3, "Veuillez entrer les informations relatives \u00e0 Keystore"
    ...
    const-string v3, "Alias pour Keystore : "
    ...
    const-string v3, "Mot de passe pour Keystore : "
    ...
    const-string v3, "Mot de passe de cl\u00e9 priv\u00e9e (facultatif) : "
    ...
    const-string v3, "Nom d\'\'utilisateur Kerberos [{0}] : "
    ...
    const-string v3, "Mot de pass\u00e9 Kerberos pour {0} : "
    ...
    const-string v3, " : erreur d\'analyse "
    ...
    const-string v3, " : erreur d\'ajout de permission "
    ...
    const-string v3, " : erreur d\'ajout d\'entr\u00e9e "
    ...
    const-string v3, "tentative d\'ajout de permission \u00e0 un ensemble de permissions en lecture seule"
    ...
    const-string v3, "type de Keystore attendu"
    ...
    const-string v3, "impossible de sp\u00e9cifier Principal avec une"
    ...
    const-string v3, "classe g\u00e9n\u00e9rique sans nom g\u00e9n\u00e9rique"
    ...
    const-string v3, "codeBase ou SignedBy attendu"
    ...
    const-string v3, "seules les entr\u00e9es bas\u00e9es sur Principal sont autoris\u00e9es"
    ...
    const-string v3, "entr\u00e9e de permission attendue"
    ...
    const-string v3, ", lecture de fin de fichier"
    ...
    const-string v3, "attendu \';\', lecture de fin de fichier"
    ...
    const-string v3, "SolarisNumericGroupPrincipal [groupe principal] : "
    ...
    const-string v3, "SolarisNumericGroupPrincipal [groupe suppl\u00e9mentaire] : "
    ...
    const-string v2, "nom Null sp\u00e9cifi\u00e9"
