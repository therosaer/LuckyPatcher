...
# instance fields
.field private size:Lcom/startapp/sdk/ads/banner/d;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v2}, Lcom/startapp/sdk/ads/banner/d;-><init>(II)V

    const/4 v3, 0x0

    const-string v4, "XXSMALL"

    invoke-direct {v0, v4, v3, v1}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/sdk/ads/banner/d;)V
    ...
    invoke-direct {v1, v4, v2}, Lcom/startapp/sdk/ads/banner/d;-><init>(II)V

    const/4 v4, 0x1

    const-string v5, "XSMALL"

    invoke-direct {v0, v5, v4, v1}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/sdk/ads/banner/d;)V
    ...
    invoke-direct {v1, v5, v2}, Lcom/startapp/sdk/ads/banner/d;-><init>(II)V

    const/4 v2, 0x2

    const-string v5, "SMALL"

    invoke-direct {v0, v5, v2, v1}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/sdk/ads/banner/d;)V
    ...
    invoke-direct {v1, v5, v6}, Lcom/startapp/sdk/ads/banner/d;-><init>(II)V

    const/4 v5, 0x3

    const-string v6, "MEDIUM"

    invoke-direct {v0, v6, v5, v1}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/sdk/ads/banner/d;)V
    ...
    invoke-direct {v1, v7, v6}, Lcom/startapp/sdk/ads/banner/d;-><init>(II)V

    const/4 v7, 0x4

    const-string v8, "LARGE"

    invoke-direct {v0, v8, v7, v1}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/sdk/ads/banner/d;)V
    ...
    invoke-direct {v1, v8, v6}, Lcom/startapp/sdk/ads/banner/d;-><init>(II)V

    const/4 v6, 0x5

    const-string v8, "XLARGE"

    invoke-direct {v0, v8, v6, v1}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/sdk/ads/banner/d;)V
...
.method private constructor <init>(Ljava/lang/String;ILcom/startapp/sdk/ads/banner/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "Lcom/startapp/sdk/ads/banner/d;",
            ")V"
        }
    .end annotation
    ...
    .line 31
    iput-object p3, p0, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;->size:Lcom/startapp/sdk/ads/banner/d;
...
# virtual methods
.method public final getSize()Lcom/startapp/sdk/ads/banner/d;
    .locals 1

    .line 35
    iget-object v0, p0, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;->size:Lcom/startapp/sdk/ads/banner/d;
