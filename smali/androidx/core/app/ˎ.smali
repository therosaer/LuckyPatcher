.class public abstract Landroidx/core/app/ˎ;
...
# virtual methods
.method public ʻ(Landroid/view/View;Landroid/graphics/Matrix;Landroid/graphics/RectF;)Landroid/os/Parcelable;
    .locals 5
    ...
    .line 173
    invoke-static {v1}, Landroidx/core/app/ˎ;->ʻ(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Bitmap;
    ...
    .line 196
    iget-object v3, p0, Landroidx/core/app/ˎ;->ʻ:Landroid/graphics/Matrix;
    ...
    iput-object v3, p0, Landroidx/core/app/ˎ;->ʻ:Landroid/graphics/Matrix;
    ...
    .line 200
    iget-object p2, p0, Landroidx/core/app/ˎ;->ʻ:Landroid/graphics/Matrix;
    ...
    .line 204
    iget-object p3, p0, Landroidx/core/app/ˎ;->ʻ:Landroid/graphics/Matrix;
...
.method public ʻ(Landroid/content/Context;Landroid/os/Parcelable;)Landroid/view/View;
    .locals 2
...
.method public ʻ(Ljava/util/List;Ljava/util/List;Landroidx/core/app/ˎ$ʻ;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 301
    invoke-interface {p3}, Landroidx/core/app/ˎ$ʻ;->ʻ()V

    return-void
.end method

.method public ʻ(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public ʻ(Ljava/util/List;Ljava/util/Map;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public ʼ(Ljava/util/List;Ljava/util/List;Ljava/util/List;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
