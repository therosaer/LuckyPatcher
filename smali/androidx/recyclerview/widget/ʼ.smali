...
.method private ˆ(I)I
    ...
    invoke-interface {v1}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʻ()I
    ...
    invoke-virtual {v3, v2}, Landroidx/recyclerview/widget/ʼ$ʻ;->ʿ(I)I
    ...
    invoke-virtual {p1, v2}, Landroidx/recyclerview/widget/ʼ$ʻ;->ʽ(I)Z
...
.method private ˈ(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʽ(Landroid/view/View;)V

    return-void
.end method

.method private ˉ(Landroid/view/View;)Z
    .locals 1
    ...
    invoke-interface {v0, p1}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʾ(Landroid/view/View;)V
...
.method ʻ()V
    ...
    invoke-interface {v1, v2}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʾ(Landroid/view/View;)V
    ...
    invoke-interface {v0}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʼ()V
...
.method ʻ(I)V
    ...
    .line 160
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/ʼ;->ˆ(I)I
    ...
    invoke-interface {v0, p1}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʼ(I)Landroid/view/View;
    ...
    .line 166
    invoke-direct {p0, v0}, Landroidx/recyclerview/widget/ʼ;->ˉ(Landroid/view/View;)Z

    .line 168
    :cond_1
    iget-object v0, p0, Landroidx/recyclerview/widget/ʼ;->ʻ:Landroidx/recyclerview/widget/ʼ$ʼ;

    invoke-interface {v0, p1}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʻ(I)V
...
.method ʻ(Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʻ(Landroid/view/View;)I
    ...
    .line 145
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/ʼ;->ˉ(Landroid/view/View;)Z

    .line 147
    :cond_1
    iget-object p1, p0, Landroidx/recyclerview/widget/ʼ;->ʻ:Landroidx/recyclerview/widget/ʼ$ʼ;

    invoke-interface {p1, v0}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʻ(I)V

    return-void
.end method

.method ʻ(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;Z)V
    .locals 1
    ...
    invoke-interface {p2}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʻ()I
    ...
    .line 233
    :cond_0
    invoke-direct {p0, p2}, Landroidx/recyclerview/widget/ʼ;->ˆ(I)I
    ...
    invoke-virtual {v0, p2, p4}, Landroidx/recyclerview/widget/ʼ$ʻ;->ʻ(IZ)V

    if-eqz p4, :cond_1

    .line 237
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/ʼ;->ˈ(Landroid/view/View;)V

    .line 239
    :cond_1
    iget-object p4, p0, Landroidx/recyclerview/widget/ʼ;->ʻ:Landroidx/recyclerview/widget/ʼ$ʼ;

    invoke-interface {p4, p1, p2, p3}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʻ(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
...
.method ʻ(Landroid/view/View;IZ)V
    ...
    invoke-virtual {v0, p2, p3}, Landroidx/recyclerview/widget/ʼ$ʻ;->ʻ(IZ)V
    ...
    invoke-interface {p3, p1, p2}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʻ(Landroid/view/View;I)V

    return-void
.end method

.method ʻ(Landroid/view/View;Z)V
    .locals 1
...
.method ʼ()I
    ...
    invoke-interface {v0}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʻ()I
...
.method ʽ(I)Landroid/view/View;
    ...
    invoke-interface {v3, v2}, Landroidx/recyclerview/widget/ʼ$ʼ;->ʼ(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ﹶ;
...
.method ʿ(I)V
    ...
    invoke-virtual {v0, p1}, Landroidx/recyclerview/widget/ʼ$ʻ;->ʾ(I)Z
...
.method ʿ(Landroid/view/View;)V
    ...
    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/ʼ$ʻ;->ʽ(I)Z
    ...
    invoke-virtual {v1, v0}, Landroidx/recyclerview/widget/ʼ$ʻ;->ʼ(I)V
...
.method ˆ(Landroid/view/View;)Z
    ...
    .line 380
    :cond_0
    iget-object v2, p0, Landroidx/recyclerview/widget/ʼ;->ʼ:Landroidx/recyclerview/widget/ʼ$ʻ;

    invoke-virtual {v2, v0}, Landroidx/recyclerview/widget/ʼ$ʻ;->ʽ(I)Z
    ...
    invoke-virtual {v2, v0}, Landroidx/recyclerview/widget/ʼ$ʻ;->ʾ(I)Z
